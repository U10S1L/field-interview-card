      ...
      <div className="row">
        <div className="col-12">
          <form className="g-0" onSubmit={handleSubmit(onSubmit)}>
            <div className="mt-1 mb-3 col-12 mt-1 d-flex">
            ...
            <div className="col-12">
              <button className="btn btn-light flip-button" style={{ borderRadius: 0 }} onClick={() => setVisibleSide(prev => prev === "FRONT" ? "BACK" : "FRONT")}>
                {visibleSide}
                {" "}
