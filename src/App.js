...
function App() {
  ...
  return (
    <div className="container">
      <form className="g-0" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mt-5">
          ...
          <div className="row border-top border-black gx-0">
            ...
            <div className="col-6 border-start border-black border-end">
      ...
      <button type="button" className="btn btn-secondary mt-3" data-bs-toggle="modal" data-bs-target="#importModal">Import</button>
      <button type="button" className="btn btn-warning mt-3" onClick={() => reset()}>Clear</button>

      <div className="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="importModal" tabIndex="-1">
